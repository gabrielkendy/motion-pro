...
set "SRC=%~dp0MotionPro-IA"
set "CEP_CACHE=%LOCALAPPDATA%\Temp\cep_cache"

echo.
echo  ============================================================
echo.
echo               M O T I O N   P R O   ·   I A
echo.
echo            Agente de Edicao IA para Premiere Pro
echo                       by PacotesFX
echo.
echo  ============================================================
echo.
...
if not exist "%SRC%" (
    color 0C
    echo  [ERRO] Pasta "MotionPro-IA" nao encontrada em: %SRC%
    pause
    exit /b 1
)
...
echo.
echo  ============================================================
echo       ✓  M O T I O N   P R O   I A   I N S T A L A D O
echo  ============================================================
echo.
echo    1. Abra o Adobe Premiere Pro
echo    2. Menu Janela ^> Extensoes ^> MotionPro IA
echo    3. Faca login (mesma conta dos outros plugins)
echo    4. Comece falando com a IA via aba CHAT
echo.
echo    Exemplos do que pedir:
echo      - "Corta todos os silencios maiores que 0.7s"
echo      - "Lista os clips da timeline"
echo      - "Adiciona corte aos 12s, 28s e 45s"
echo.
