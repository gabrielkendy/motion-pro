...
INSERT INTO products(id, name, description) VALUES
    ('Motion Titles',  'Motion Titles',           '7.906 templates de motion graphics premium'),
    ('legendas',   'Motion Legendas',  'Plugin de títulos, lower thirds e legendas estilizadas'),
    ('bundle_all', 'Pacote Completo',     'Motion Titles + Legendas — todos os plugins')
...
-- Backfill: subs existentes pertencem ao Motion Titles
...
-- Seed inicial: prices do Motion Titles (já existentes no Stripe)
